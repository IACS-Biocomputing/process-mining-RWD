...
check_attributes <- function(eventlog, attribute_name, attribute_values) {
	FUN <- ifelse(attribute_name == "case_id", bupaR.IACSmod::case_id,
				  ifelse(  attribute_name == "activity_id", bupaR.IACSmod::activity_id,
				  		 ifelse(  attribute_name == "activity_instance_id", bupaR.IACSmod::activity_instance_id,
				  		 		 ifelse( attribute_name == "resource_id", bupaR.IACSmod::resource_id, bupaR.IACSmod::lifecycle_id))))
